...
//	private FrameLayout mContent;
	...
	private boolean mZoomHeaderImage;
...
//		Log.d(TAG, "onLayout");
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			mLastScale = ((float) mHeaderImage.getBottom()) / mHeaderHeight;
			Log.i(TAG, "down scale:" + mLastScale);
			Log.i(TAG, "height:" + mHeaderHeight);
			Log.i(TAG, "bottom:" + mHeaderImage.getBottom());
//			Log.i(TAG, "next top:" + getChildAt(1).getTop());
			mHeaderImage.setScaleType(ScaleType.CENTER_CROP);
			break;
		...
		case MotionEvent.ACTION_MOVE:
			...
			// }
			// }
//			Log.i(TAG, "mHeaderImage.getBottom():" + mHeaderImage.getBottom());
			if (mHeaderImage.getBottom() >= mHeaderHeight) {

//				Log.d(TAG, "Scaling..................");
				ViewGroup.LayoutParams params = mHeaderImage.getLayoutParams();

				float dy = ev.getY(activePointerIndex) - mLastMotionY;
				float scale = (mHeaderImage.getBottom() + dy) / mHeaderHeight;
...
////		Log.d(TAG, "onScrollChanged:Y:" + getScrollY());
...
//	}
	...
	class ScalingRunnalable implements Runnable {
		...
		public void startAnimation(long duration) {
			...
			mDuration = duration;
			mScale = (float) mHeaderImage.getBottom() / mHeaderHeight;
			mIsFinished = false;
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (mZoomHeaderImage) {
			float scrollY = mHeaderHeight - mHeaderImage.getBottom();
			if (scrollY > 0 && scrollY < mHeaderHeight) {
				int s = (int) (scrollY * 0.65);
				mHeaderImage.scrollTo(0, -s);
			} else if (mHeaderImage.getScrollY() != 0) {
				mHeaderImage.scrollTo(0, 0);
			}
